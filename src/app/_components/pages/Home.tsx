...
import AnimatedVerticalLine from "../molecules/animatedVerticalLine";
import AnimatedBars from "../molecules/bars";
import BlinkingArrowSection from "../molecules/blinking";
import StatsGrid from "../molecules/circle";
import InfiniteChat from "../molecules/infinitechat";
import HeaderMobile from "../molecules/mobileheader";
import CalculatePrice from "../molecules/priceCalc";
import FAQSection from "../molecules/questions";
import SvgTree from "../molecules/svgtweakedline";
import gsap from "gsap";

import { useRef } from "react";
import AnimatedPoint from "../molecules/animatedPoints";
  ...
  return (
    <>
        <div className="absolute inset-0 min-h-[100vh] bg-[#020E0F] pointer-events-none overflow-x-clip -z-10">        
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[180vw] h-[180vw] xl:w-[120vw] xl:h-[120vw]">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150vw] h-[150vw] xl:w-[100vw] xl:h-[100vw]">
            <div className="metal-border-wrapper w-full h-full rounded-full">
                <div className="metal-border-vertical rounded-full"></div>
                <div className="w-full h-full rounded-full bg-[#021011] z-[1] relative"></div>
            </div>
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#011617] opacity-100 w-[120vw] h-[120vw] xl:w-[80vw] xl:h-[80vw]">
            <div className="metal-border-wrapper w-full h-full rounded-full">
                <div className="metal-border rounded-full"></div>
                <div className="w-full h-full rounded-full bg-[#011617] z-[1] relative"></div>
            </div>
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#041C1D] opacity-100 w-[90vw] h-[90vw] xl:w-[60vw] xl:h-[60vw]">
            <div className="metal-border-wrapper w-full h-full rounded-full">
                <div className="metal-border-vertical rounded-full"></div>
                <div className="w-full h-full rounded-full bg-[#041C1D] z-[1] relative"></div>
            </div>
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#042627] opacity-100 w-[60vw] h-[60vw] xl:w-[40vw] xl:h-[40vw]">
            <div className="metal-border-wrapper w-full h-full rounded-full">
                <div className="metal-border rounded-full"></div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#073032] opacity-100 w-[22.5vw] h-[22.5vw] xl:w-[15vw] xl:h-[15vw]">
                <div className="metal-border-wrapper w-full h-full rounded-full">
                <div className="metal-border-vertical rounded-full"></div>
            ...
            <AnimatedVerticalLine onFinish={() => setShowPoints(true)} finishAll={finishAll} />
        ...
        <section className="h-[100vh] lg:h-[100vh] overflow-x-hidden text-white relative grid grid-cols-12 gap-4 sm:gap-5 py-0 lg:py-5 grid-rows-7 sm:grid-rows-7 justify-between">
            ...
            {/* Header */}
            <header className="relative z-10 hidden col-start-2 col-end-12 lg:flex justify-between items-center mb-10 h-32 p-5 px-12 mx-0 xl:mx-24 overflow-hidden rounded-4xl bg-[#137A7F]/10 shadow-lg backdrop-blur-sm border border-white/20">
            ...
            <h1 className='p-1 sm:p-0 text-3xl text-nowrap sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl 2xl:text-7xl font-bold'>Gerenciando Grupos Vip<br />Com Qualidade</h1>
            </div>
        ...
        <section className="grid grid-cols-12 auto-rows-auto gap-5 sm:hidden bg-[#020E0F] py-5 text-white">
            ...
            <div className='grid col-start-2 w-full col-end-10 row-start-3 lg:hidden grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-around gap-18 h-72'>
                ...
                <div className="relative glow-hover hover:scale-105 hover:border-cyan-300 hover:border transition hover:shadow-glow hover:shadow-cyan-400 col-start-1 col-end-4 grid grid-cols-12 grid-rows-4 rounded-3xl overflow-hidden bg-gradient-to-b from-[#042425] to-[#041B1C]">
                    <div className="absolute inset-0 rounded-3xl border-[1px] border-transparent bg-gradient-to-tl from-[rgb(3,88,84)] via-transparent to-transparent pointer-events-none"></div>
            ...
            <div className='grid col-start-4 w-full col-end-12 row-start-4 lg:hidden grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-around gap-18 h-72'>
                ...
                <div className="relative w-full glow-hover hover:scale-105 hover:border-cyan-300 hover:border transition hover:shadow-glow hover:shadow-cyan-400 grid grid-cols-12 grid-rows-4 rounded-3xl overflow-hidden bg-gradient-to-b from-[#042425] to-[#041B1C]">
                    ...
                    {/* Content */}
                    <div className="relative z-10 col-start-2 col-end-12 flex items-center justify-center text-center">
                        <h3 className="font-medium text-xl text-center">Dinheiro no Bolso</h3>
                    </div>
        ...
        {/*Pontos*/}
        <section className="relative bg-[#020E0F] overflow-visible z-20 sm:-z-20">
            <div className="relative mb-0 sm:mb-[5vw] z-10 grid grid-cols-12 gap-5 py-5 grid-rows-8 justify-between text-white h-[100vw] xl:h-[72.5vw] max-h-[72.5vw] overflow-visible">
            
                <div className="sm:hidden col-start-2 col-end-12 row-start-2 row-end-4 flex flex-col gap-2 items-center text-center relative z-30">
                    <img src="/assets/lightining.svg" alt="My Icon" className="w-10 sm:w-[3vw] sm:h-[3vw] z-30 rounded-full bg-[#020E0F] border-[0.2vw] border-[#86CECB] shadow-md" />
                    <h2 className="text-2xl sm:text-[2.2vw] font-semibold">Configuração Rápida</h2>
                    <p className="text sm:text-[1vw]">
                        Sem muita dificuldade em minutos seu bot estará pronto para atuação em seu grupo
                    </p>
                </div>

                <div className="sm:hidden col-start-2 col-end-12 row-start-4 row-end-6 flex flex-col gap-2 items-center text-center relative z-30">
                    <img src="/assets/Fire_light.svg" alt="My Icon" className="w-10 sm:w-[3vw] sm:h-[3vw] z-30 rounded-full bg-[#020E0F] border-[0.2vw] border-[#86CECB] shadow-md" />
                    <h2 className="text-2xl sm:text-[2.2vw] font-semibold">Planos Garantidos</h2>
                    <p className="text sm:text-[1vw]">
                        Gerencie os planos, suas durações e preços de maneira fácil.
                    </p>
                </div>

                <div className="col-start-2 col-end-12 sm:col-start-5 sm:col-end-9 row-start-6 row-end-9 flex flex-col gap-2 items-center text-center relative z-30">
                    <img src="/assets/Star.svg" alt="My Icon" className="w-10 sm:w-[3vw] sm:h-[3vw] z-30 rounded-full bg-[#020E0F] border-[0.2vw] border-[#86CECB] shadow-md" />
                    ...
                    <div className="absolute top-0 sm:top-1/2 left-1/2 -translate-x-1/2 -translate-y-[20%] sm:-translate-y-[60%] w-[100vw] h-[100vw]  sm:w-[60vw] sm:h-[60vw] bg-[radial-gradient(circle,#106D75_0%,rgba(2,14,15,0.2)_70%,rgba(2,14,15,0.9)_100%)] blur-3xl rounded-full -z-10 pointer-events-none"></div>
        ...
        <section className="relative h-[100vh] z-30 bg-[#020E0F] ">
            <div className="absolute inset-0 z-50 bg-[#020E0F] overflow-x-clip grid grid-cols-12 grid-rows-9">
                ...
                <div className="flex flex-col justify-center items-center text-center sm:items-start sm:text-start sm:justify-start">
                    <div className="z-60"> 
                    <h2 className="text-2xl sm:text-5xl text-nowrap font-bold mb-4">Pronto para começar?</h2>
                    </div>

                    <div className="flex z-30 justify-start">
                    <button className='bg-[#86CECB] cursor-pointer text-md font-bold text-black py-2 px-4 rounded-xl hover:bg-[#E12885] z-10'>
                    Comece Sem Custos
                    </button>
                    </div>
                </div>
